...
public class ActionDemo implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        var clientFoundByName = clientRepository
                ...
                .orElseThrow(() -> new RuntimeException("client not found, name:" + firstClient.name()));
        ...
        var updatedClient =
                clientRepository.findById(firstClient.id()).orElseThrow(() -> new RuntimeException("client not found"));
